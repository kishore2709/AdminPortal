...
public class ApptransHoldReasons implements Serializable {
    ...
    @OneToMany(mappedBy="apptransHoldReasons")
    private Set<ApptransAppholdRel> apptransAppholdRel;
    ...
    /**
     * Access method for apptransAppholdRel.
     *
     * @return the current value of apptransAppholdRel
     */
    public Set<ApptransAppholdRel> getApptransAppholdRel() {
        return apptransAppholdRel;
    }

    /**
     * Setter method for apptransAppholdRel.
     *
     * @param aApptransAppholdRel the new value for apptransAppholdRel
     */
    public void setApptransAppholdRel(Set<ApptransAppholdRel> aApptransAppholdRel) {
        apptransAppholdRel = aApptransAppholdRel;
    }

...
@Entity(name="registration_items_bckup_122018")
public class RegistrationItemsBckup122018 implements Serializable {
    ...
    @Column(name="Expiration_Date_Type_UID", precision=10)
    private int expirationDateTypeUid;
    ...
    /** Default constructor. */
    public RegistrationItemsBckup122018() {
        super();
    }
    ...
    /**
     * Access method for expirationDateTypeUid.
     *
     * @return the current value of expirationDateTypeUid
     */
    public int getExpirationDateTypeUid() {
        return expirationDateTypeUid;
    }

    /**
     * Setter method for expirationDateTypeUid.
     *
     * @param aExpirationDateTypeUid the new value for expirationDateTypeUid
     */
    public void setExpirationDateTypeUid(int aExpirationDateTypeUid) {
        expirationDateTypeUid = aExpirationDateTypeUid;
    }
    ...
    /**
     * Compares the key for this instance with another RegistrationItemsBckup122018.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegistrationItemsBckup122018 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegistrationItemsBckup122018)) {
            return false;
        }
        RegistrationItemsBckup122018 that = (RegistrationItemsBckup122018) other;
    ...
    /**
     * Compares this instance with another RegistrationItemsBckup122018.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegistrationItemsBckup122018)) return false;
        return this.equalKeys(other) && ((RegistrationItemsBckup122018)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegistrationItemsBckup122018 |");

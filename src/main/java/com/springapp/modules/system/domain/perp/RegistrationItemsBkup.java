...
@Entity(name="registration_items_bkup")
public class RegistrationItemsBkup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another RegistrationItemsBkup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegistrationItemsBkup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegistrationItemsBkup)) {
            return false;
        }
        RegistrationItemsBkup that = (RegistrationItemsBkup) other;
    ...
    /**
     * Compares this instance with another RegistrationItemsBkup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegistrationItemsBkup)) return false;
        return this.equalKeys(other) && ((RegistrationItemsBkup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegistrationItemsBkup |");
